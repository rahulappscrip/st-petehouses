...
export const FAQ_PAGE_CATEGORIES: readonly FaqPageCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "A real person — every time. We are a locally owned company based in St Petersburg. Benette Andrew is involved in every transaction and the people you speak with are members of our local team who know Pinellas County, the neighborhoods, and the specific situations that bring sellers to us. No offshore call centers, no automated systems.",
      },
      {
  ...
  items: [
    {
      ...
      body: "Speak directly with our St Petersburg team. Benette Andrew and the team answer personally — no call centers, no bots. Available Monday–Friday 8am–7pm, Saturday 9am–5pm.",
      link: {
        label: "(727) 477-8998",
